"""
Django settings for ethiopian_places project.
...
ROOT_URLCONF = 'ethiopian_places.urls'
...
WSGI_APPLICATION = 'ethiopian_places.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': os.environ.get('DB_NAME', 'telusko'),
        'USER': os.environ.get('DB_USER', 'postgres'),
        'PASSWORD': os.environ.get('DB_PASSWORD', 'adigrat04'),
